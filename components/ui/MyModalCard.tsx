...
const MyModalCard = ({
  ...
  return (
    ...
    >
      <div className="container mx-auto lg:px-80  overflow-y-auto">
        <div className=" px-8 py-8 overflow-hidden relative bg-gray-800 rounded-2xl ">
          <div className="flex justify-end pr-4 pt-2">
            <button
              className="text-3xl leading-none text-white hover:text-gray-400"
          ...
          <p className="font-extrabold text-4xl p-7  text-white flex justify-center self-center">
            {modalTitle}
          </p>
          {children}
        </div>
